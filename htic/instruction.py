...
class Instruction(object):
	...
	def newInstruction(name):
		if   name == "ABS":       return Instruction(name, 0x64, 0, ('VAL',), True)
		elif name == "ADD":       return Instruction(name, 0x60, 0, ('VAL', 'VAL'), True)
		elif name == "ALIGNPTS":  return Instruction(name, 0x27, 0, ('VAL', 'VAL'), False)
		elif name == "ALIGNRP":   return LoopInstruction(name, 0x3C, 0, ('VAL', 'VAL*'), False)
		elif name == "AND":       return Instruction(name, 0x5A, 0, ('VAL', 'VAL'), True)
		elif name == "CALL":      return CallInstruction(name, 0x2B, 0, ('CALL', 'VAL*'), True, 1)
		elif name == "CEILING":   return Instruction(name, 0x67, 0, ('VAL',), True)
		elif name == "CINDEX":    return Instruction(name, 0x25, 0, ('VAL',), True)
		elif name == "CLEAR":     return Instruction(name, 0x22, 0, (), True) # special case for mightPush
		elif name == "DEBUG":     return Instruction(name, 0x4F, 0, ('VAL',), False)
		elif name == "deltac":    return DeltaInstruction(name.upper(), None, 0, ('CVT', 'DELTA', 'DELTA*'), False)
		elif name == "deltap":    return DeltaInstruction(name.upper(), None, 0, ('VAL', 'DELTA', 'DELTA*'), False)
		elif name == "DEPTH":     return Instruction(name, 0x24, 0, (), True)
		elif name == "DUP":       return Instruction(name, 0x20, 0, (), True)
		elif name == "DIV":       return Instruction(name, 0x62, 0, ('VAL', 'VAL'), True)
		...
		elif name == "EQ":        return Instruction(name, 0x54, 0, ('VAL', 'VAL'), True)
		elif name == "EVEN":      return Instruction(name, 0x57, 0, ('VAL',), True)
		elif name == "FDEF":      return BlockInstruction(name, 0x2C, 0, ('FDEF',), False, ("ENDF",))
		elif name == "FLIPOFF":   return Instruction(name, 0x4E, 0, (), False)
		elif name == "FLIPON":    return Instruction(name, 0x4D, 0, (), False)
		elif name == "FLIPPT":    return LoopInstruction(name, 0x80, 0, ('VAL', 'VAL*'), False)
		elif name == "FLIPRGOFF": return Instruction(name, 0x82, 0, ('VAL', 'VAL'), False)
		elif name == "FLIPRGON":  return Instruction(name, 0x81, 0, ('VAL', 'VAL'), False)
		elif name == "FLOOR":     return Instruction(name, 0x66, 0, ('VAL',), True)
		elif name == "GC":        return Instruction(name, 0x46, 1, ('VAL',), True)
		elif name == "GETINFO":   return Instruction(name, 0x88, 0, ('VAL',), True)
		elif name == "GFV":       return Instruction(name, 0x0D, 0, (), True)
		elif name == "GPV":       return Instruction(name, 0x0C, 0, (), True)
		elif name == "GT":        return Instruction(name, 0x52, 0, ('VAL', 'VAL'), True)
		elif name == "GTEQ":      return Instruction(name, 0x53, 0, ('VAL', 'VAL'), True)
		elif name == "IF":        return BlockInstruction(name, 0x58, 0, ('VAL',), False, ("ELSE", "EIF"))
		elif name == "INSTCTRL":  return Instruction(name, 0x8E, 0, ('VAL', 'VAL'), False)
		elif name == "IP":        return LoopInstruction(name, 0x39, 0, ('VAL', 'VAL*'), False)
		elif name == "ISECT":     return Instruction(name, 0x0F, 0, ('VAL', 'VAL', 'VAL', 'VAL', 'VAL'), False)
		elif name == "IUP":       return Instruction(name, 0x30, 1, (), False)
		elif name == "JMPR":      return Instruction(name, 0x1C, 0, ('VAL',), False)
		elif name == "JROF":      return Instruction(name, 0x79, 0, ('VAL', 'VAL'), False)
		elif name == "JROT":      return Instruction(name, 0x78, 0, ('VAL', 'VAL'), False)
		elif name == "LOOPCALL":  return CallInstruction(name, 0x2A, 0, ('VAL', 'CALL', 'VAL*'), True, 2)
		elif name == "LT":        return Instruction(name, 0x50, 0, ('VAL', 'VAL'), True)
		elif name == "LTEQ":      return Instruction(name, 0x51, 0, ('VAL', 'VAL'), True)
		elif name == "MAX":       return Instruction(name, 0x8B, 0, ('VAL', 'VAL'), True)
		elif name == "MD":        return Instruction(name, 0x49, 1, ('VAL', 'VAL'), True)
		elif name == "MDAP":      return Instruction(name, 0x2E, 1, ('VAL',), False)
		elif name == "MDRP":      return Instruction(name, 0xC0, 31, ('VAL',), False)
		elif name == "MIAP":      return Instruction(name, 0x3E, 1, ('VAL', 'CVT'), False)
		elif name == "MIN":       return Instruction(name, 0x8C, 0, ('VAL', 'VAL'), True)
		elif name == "MINDEX":    return Instruction(name, 0x26, 0, ('VAL',), True)
		elif name == "MIRP":      return Instruction(name, 0xE0, 31, ('VAL', 'CVT'), False)
		elif name == "MPPEM":     return Instruction(name, 0x4B, 0, (), True)
		elif name == "MPS":       return Instruction(name, 0x4C, 0, (), True)
		elif name == "MSIRP":     return Instruction(name, 0x3A, 1, ('VAL', 'VAL'), False)
		elif name == "MUL":       return Instruction(name, 0x63, 0, ('VAL', 'VAL'), True)
		elif name == "NEG":       return Instruction(name, 0x65, 0, ('VAL',), True)
		elif name == "NEQ":       return Instruction(name, 0x55, 0, ('VAL', 'VAL'), True)
		elif name == "NOT":       return Instruction(name, 0x5C, 0, ('VAL',), True)
		elif name == "NROUND":    return Instruction(name, 0x6C, 3, ('VAL',), True)
		elif name == "ODD":       return Instruction(name, 0x56, 0, ('VAL',), True)
		elif name == "OR":        return Instruction(name, 0x5B, 0, ('VAL', 'VAL'), True)
		elif name == "POP":       return Instruction(name, 0x21, 0, (), False)
		elif name == "push":      return Instruction(None, None, 0, ('VAL*',), True)
		elif name == "RCVT":      return Instruction(name, 0x45, 0, ('CVT',), True)
		...
		elif name == "ROUND":     return Instruction(name, 0x68, 3, ('VAL',), True)
		elif name == "RS":        return Instruction(name, 0x43, 0, ('RS',), True)
		...
		elif name == "S45ROUND":  return Instruction(name, 0x77, 0, ('VAL',), False)
		elif name == "SCANCTRL":  return Instruction(name, 0x85, 0, ('VAL',), False)
		elif name == "SCANTYPE":  return Instruction(name, 0x8D, 0, ('VAL',), False)
		elif name == "SCFS":      return Instruction(name, 0x48, 0, ('VAL', 'VAL'), False)
		elif name == "SCVTCI":    return Instruction(name, 0x1D, 0, ('VAL',), False)
		elif name == "SDB":       return Instruction(name, 0x5E, 0, ('VAL',), False)
		elif name == "SDPVTL":    return Instruction(name, 0x86, 1, ('VAL', 'VAL'), False)
		elif name == "SDS":       return Instruction(name, 0x5F, 0, ('VAL',), False)
		elif name == "SFVFS":     return Instruction(name, 0x0B, 0, ('VAL', 'VAL'), False)
		elif name == "SFVTCA":    return Instruction(name, 0x04, 1, (), False)
		elif name == "SFVTL":     return Instruction(name, 0x08, 1, ('VAL', 'VAL'), False)
		elif name == "SFVTPV":    return Instruction(name, 0x0E, 0, (), False)
		elif name == "SHC":       return Instruction(name, 0x34, 1, ('VAL',), False)
		elif name == "SHP":       return LoopInstruction(name, 0x32, 1, ('VAL', 'VAL*'), False)
		elif name == "SHPIX":     return Instruction(name, 0x38, 0, ('VAL', 'VAL', 'VAL*'), False)
		elif name == "SHZ":       return Instruction(name, 0x36, 1, ('VAL',), False)
		elif name == "SLOOP":     return Instruction(name, 0x17, 0, ('VAL',), False)
		elif name == "SMD":       return Instruction(name, 0x1A, 0, ('VAL',), False)
		elif name == "SPVFS":     return Instruction(name, 0x0A, 0, ('VAL', 'VAL'), False)
		elif name == "SPVTCA":    return Instruction(name, 0x02, 1, (), False)
		elif name == "SPVTL":     return Instruction(name, 0x06, 1, ('VAL', 'VAL'), False)
		elif name == "SROUND":    return Instruction(name, 0x76, 0, ('VAL',), False)
		elif name == "SRP0":      return Instruction(name, 0x10, 0, ('VAL',), False)
		elif name == "SRP1":      return Instruction(name, 0x11, 0, ('VAL',), False)
		elif name == "SRP2":      return Instruction(name, 0x12, 0, ('VAL',), False)
		elif name == "SSW":       return Instruction(name, 0x1F, 0, ('VAL',), False)
		elif name == "SSWCI":     return Instruction(name, 0x1E, 0, ('VAL',), False)
		elif name == "SUB":       return Instruction(name, 0x61, 0, ('VAL', 'VAL'), True)
		elif name == "SVTCA":     return Instruction(name, 0x00, 1, (), False)
		elif name == "SWAP":      return Instruction(name, 0x23, 0, (), True)
		elif name == "SZP0":      return Instruction(name, 0x13, 0, ('VAL',), False)
		elif name == "SZP1":      return Instruction(name, 0x14, 0, ('VAL',), False)
